    ...
    <div>
      {done ? (
        ...
        <div className="flex flex-col justify-center items-center text-center">
          <h1 className="font-bold text-5xl">אישור הגעה</h1>
          <h1 className="font-medium text-3xl">נשמח לראותכם בין אורחינו</h1>
          <div
          ...
          >
            <div className="flex flex-row items-center justify-between mb-4">
              <input
                ref={fNameRef}
                className="border-[#7ba7b3] text-[#7ba7b3] font-bold outline-none border-b-[4px] w-[45%] focus:border-black transition-colors duration-700 p-2"
                placeholder="שם פרטי"
              />
              <input
                ref={lNameRef}
